...
import { Fn, MaybeRef, ConfigurableEventFilter, ConfigurableFlush, RemoveableRef, EventHookOn, Pausable } from '@vueuse/shared';
...
declare const StorageSerializers: Record<'boolean' | 'object' | 'number' | 'any' | 'string', Serializer<any>>;
 ...
 * @param options
 */
declare function useScroll(element: MaybeRef<HTMLElement | SVGElement | Window | Document>, options?: UseScrollOptions): {
    x: vue_demi.Ref<number>;
    y: vue_demi.Ref<number>;
